/**
 * Following setup taken from build index.js to override custom headers
 * required for SharedArrayBuffer to work
 * */

import { handler } from '../build/handler.js';
import { env } from '../build/env.js';
import { sharedArrayBuffer } from './middleware/sharedArrayBuffer.js';
...
const server = polka()
	// This is required to enable SharedArrayBuffer work
